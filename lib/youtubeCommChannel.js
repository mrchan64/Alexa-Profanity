exports.installWebsocket = function(wssconns, sessions, keyStore) {
...
exports.uptime = new Date().getTime();
...
exports.heartBeat = function() {
  ...
  var msg = {
    ...
    'time': time,
    'struct': [],
    'keys': exports.keyStore
  }
  Object.keys(exports.sessions).forEach((session) => {
    if(exports.sessions[session].queue){
      var queue = [];
      ...
      var result = {
        title: exports.sessions[session].result.title,
        clean: exports.sessions[session].result.clean,
        id: exports.sessions[session].result.id,
        time: exports.sessions[session].result.time
      }
      var data = {
        session: session,
        result: result
...
exports.consolelog = function(str) {
  ...
  print(str)
  if(exports.wssconns)exports.wssconns.write(msg);
}
