...
var MediaQueue = function(name, config) {
  ...
  this.host = process.env.PORT ? "alexa-profanity.herokuapp.com" : "https://fe5a6fcd.ngrok.io";
  ...
  this.queue.log = () => {
    ...
    queue.forEach(function(element){
      ...
      console.log(pointer+"\t"+element.index()+" | "+queued+" | "+element.attr+".mp3 | "+element.title+" | "+element.id+" | "+element.timeString+" | "+element.data.length);
    })
  }
